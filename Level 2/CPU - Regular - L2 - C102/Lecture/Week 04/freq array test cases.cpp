...
signed main() {
    khaled
    // given an array of size N: 0 < N < 1e6 ,for each value in the array >= 0 && <= 1e6, i want to ask about something: given x print yes if it is in the list otherwise no
    // it's guranteed that summation of n , q over all test cases < 1e6
    int t;cin>>t;
    while(t--) {
        int n;cin>>n;
        for(int i = 0;i < n;i++) {
